...
if __name__ == "__main__":
    ...
    files = [
        ...
        ["./docs/implementation/03_first_rendering.md", "./docs/implementation/04_camera_control.md", "./docs/implementation/05_selection.md", "./docs/implementation/06_catalog.md", "./docs/implementation/07_object_index.md", "./docs/implementation/08_rendering_settings.md", "./docs/implementation/09_projection_grid_coordinates.md"]
    ]
